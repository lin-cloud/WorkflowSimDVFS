...
public class Pe {
   ...
   //         System.out.println("In Function \"Set_NewFrequency\" , desc =  " + desc + " / index freq =" + getIndexFreq() + " freq%=" +getPercentStep());
    ...
    public int getIndexFreqLast() {
        return indexFreqLast;
    }
    
    private void setIndexFreqMax() {
    	this.indexFreqLast= this.indexFreq;
        indexFreq=nbFreq-1;
    }
    ...
    private void setIndexFreqLast(int index_freq) {
        this.indexFreqLast = index_freq;
    }
