...
public class Host {
   ...
   //     Log.printLine("Nouveaux total = " +NewTotalVmMips);
    //    Log.printLine("HostCapacity = " +HostCapacity);
        
        setAvailableMips(HostCapacity - NewTotalVmMips);
   //     Log.printLine("Mips New VM = " +new_vm.getMips());
   //     Log.printLine("Mips libre = " +getAvailableMips());
        return true;
	}
