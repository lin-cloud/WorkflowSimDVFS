 ...
 * @date Apr 9, 2013
 */
public class WorkflowDVFSDatacenter extends PowerDatacenter
{
    public WorkflowDVFSDatacenter(String name, DatacenterCharacteristics characteristics, VmAllocationPolicy vmAllocationPolicy,
